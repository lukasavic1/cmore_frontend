 ...
 *
 * Renders status, assignee, and search filters for narrowing visible
 * tasks quickly.
 */
    ...
    >
      ...
      <div className="relative flex-1 min-w-[200px]">
        ...
        <input
          ...
          className={`w-full pl-9 pr-4 py-2 text-sm bg-[var(--surface)] border
            border-[var(--border)] rounded-xl focus:outline-none
            focus:ring-2
            focus:ring-[color-mix(in_srgb,var(--primary)_35%,transparent)]
            focus:border-[color-mix(in_srgb,var(--primary)_45%,var(--border))]
            placeholder-[var(--muted-2)] text-[var(--text)]
