 ...
 *
 * Renders the create/edit task form with client-side validation and
 * field-level errors.
 */
...
export default function TaskForm({
  ...
  function handleSubmit(e) {
    ...
    const priority = PRIORITIES.includes(form.priority)
      ? form.priority
      : "medium";
    const payload = {
    ...
    <form noValidate onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div>
        ...
        <textarea
          ...
          aria-describedby={
            errors.description ? "task-description-err" : undefined
          }
        />
        {errors.description && (
          <p
            id="task-description-err"
            className="mt-1.5 text-xs text-[var(--danger)]"
          >
            {errors.description}
          </p>
      ...
      <div className="flex gap-3">
        <div className="flex-1">
          ...
          <select
            ...
            aria-describedby={
              errors.priority ? "task-priority-err" : undefined
            }
          >
            {PRIORITIES.map((p) => (
              <option
        ...
        <div className="flex-1">
          ...
          <input
            ...
            aria-describedby={
              errors.due_date ? "task-due-date-err" : undefined
            }
          />
          {errors.due_date && (
            <p
              id="task-due-date-err"
              className="mt-1.5 text-xs text-[var(--danger)]"
            >
              {errors.due_date}
            </p>
      ...
      <div className="flex justify-end gap-2 pt-2">
        <button
          ...
          className={`px-4 py-2 text-sm text-[var(--muted)] hover:text-[var(--text)]
            transition-colors rounded-xl hover:bg-[var(--surface-2)]
          `}
        >
          Cancel
        </button>
        <button
          ...
          className={`px-5 py-2 text-sm font-medium bg-[var(--primary)] text-white
            rounded-xl hover:bg-[var(--primary-hover)] disabled:opacity-50
