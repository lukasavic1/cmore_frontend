...
import { googleSignIn as apiGoogleSignIn, getMe, logout as apiLogout } from '../api/auth'
...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, signIn, signInWithGoogle, signInWithEmail, signUpWithEmail, signOut }}>
      {children}
